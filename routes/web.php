...
Route::group(['prefix' => 'admin', 'middleware' => 'auth:admin', 'as' => 'admin.'], function () {
    ...
    route::post('userDetailsDelete', 'AdminDashboardController@deleteUser')->name('userDetails.deleteUser');
...
//Continents information data

 Route::get('/continents/data', function(){
     return view('continents.json');
 });
