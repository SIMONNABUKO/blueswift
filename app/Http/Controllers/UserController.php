...
class UserController extends Controller
{
    ...
    {
        $user = Auth::user();
        if ($user->email_verified == 1 && $user->sms_verified == 1) {
        ...
        $message = "We have received your application, but as it is with every user, we have to verify the authenticity of these
        details and once this is done, you'll receive an email from us containing your login details. Thank you!";
    ...
    public function resendVerifyEmail()
    {
        ...
        return back()->with('success', 'Please Check your mail, New email verification code sent to your email address.');
    ...
    public function resendVerifySms()
    {
        ...
        $message = "Your verification code is: " . $code;
        send_sms($to, $message);
        return back()->with('success', 'Please Check your phone, New sms verification code sent to your phone number');
...

    {
        ...
        return view('user.transferOtherBank', compact('banks', 'countries'));
    }
    ...
    public function transferOtherBank(Request $request)
    {
     ...
     $message = "The transfer of USD".' '.$amount.' '."to".' '."account number:".' '.$account."(".$branch.")".' '."failed. Please contact the bank for more information.";
     send_email($to, $name, $subject,$message);
     return back()->withErrors('Transfer failed, please contact the bank for more information.');
