...
background: -webkit-linear-gradient(-30deg, <?php echo $color2 ?> 0%, <?php echo $color ?> 100%);
background: -moz-linear-gradient(-30deg, <?php echo $color2 ?> 0%, <?php echo $color ?> 100%);
background: linear-gradient(-30deg, <?php echo $color2 ?> 0%, <?php echo $color ?> 100%);
