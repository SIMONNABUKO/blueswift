...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="{{url('assets/admin/css/')}}/color.php?color={{$gnl->color1}}&color2={{$gnl->colortwo}}" >
...
<header class="app-header"><a class="app-header__logo" href="{{route('admin.dashboard')}}">Admin</a>
    ...
    <ul class="app-nav">
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"> {{ Auth::guard('admin')->user()->name }}   <i class="fa fa-angle-double-down fa-lg"></i> </a>
    ...
    <ul class="app-menu">
        ...
        <li class="treeview @if(request()->route()->getName() == 'admin.loan.pak') is-expanded
            ...
            @elseif(request()->route()->getName() == 'admin.loan.request') is-expanded
               @endif">
            <a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-money"></i><span class="app-menu__label">Loan Management</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                <li><a class="treeview-item @if(request()->route()->getName() == 'admin.loan.pak') active @endif" href="{{route('admin.loan.pak')}}"><i class="icon fa fa-desktop"></i>Package</a></li>
                <li><a class="treeview-item @if(request()->route()->getName() == 'admin.loan.request') active @endif" href="{{route('admin.loan.request')}}"><i class="icon fa fa-desktop"></i>Loan request</a></li>


            </ul>
        </li>
        <li class="treeview @if(request()->route()->getName() == 'admin.fix.deposit.pak') is-expanded
           @elseif(request()->route()->getName() == 'admin.fix.deposit.history') is-expanded

               @endif">
            <a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-money"></i><span class="app-menu__label">Fixed Deposit</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                <li><a class="treeview-item @if(request()->route()->getName() == 'admin.fix.deposit.pak') active @endif" href="{{route('admin.fix.deposit.pak')}}"><i class="icon fa fa-desktop"></i>Package</a></li>
                <li><a class="treeview-item @if(request()->route()->getName() == 'admin.fix.deposit.history') active @endif" href="{{route('admin.fix.deposit.history')}}"><i class="icon fa fa-desktop"></i>History</a></li>
        ...
        <li class="treeview @if(request()->route()->getName() == 'admin.gateway') is-expanded
            ...
            <ul class="treeview-menu">
                <li><a class="treeview-item  @if(request()->route()->getName() == 'admin.deposits') active @endif" href="{{route('admin.deposits')}}"><i class="icon fa fa-dollar"></i>Deposits</a></li>
                 <li><a class="treeview-item @yield('gateway')" href="{{route('admin.gateway')}}"><i class="icon  fa fa-credit-card"></i>Automatic  Gateway</a></li>
                 </ul>
        </li>

        <li class="treeview @if(request()->route()->getName() == 'admin.manual.gateway') is-expanded
            @elseif(request()->route()->getName() == 'admin.manual.apdeposit') is-expanded
            @elseif(request()->route()->getName() == 'admin.manual.rdeposit') is-expanded
            @elseif(request()->route()->getName() == 'admin.manual.pdeposit') is-expanded
               @endif">
            <a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-university"></i><span class="app-menu__label">Bank Deposit</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
              <li><a class="treeview-item @yield('mgateway')" href="{{route('admin.manual.gateway')}}"><i class="icon  fa fa-credit-card"></i>Manual  Gateway</a></li>
                <li><a class="treeview-item @if(request()->route()->getName() == 'admin.manual.apdeposit') active @endif" href="{{route('admin.manual.apdeposit')}}"><i class="icon  fa fa-credit-card"></i>Approve Manual  Deposit</a></li>
                <li><a class="treeview-item @if(request()->route()->getName() == 'admin.manual.pdeposit') active @endif" href="{{route('admin.manual.pdeposit')}}"><i class="icon  fa fa-credit-card"></i>Pending Manual  Deposit</a></li>
                <li><a class="treeview-item @if(request()->route()->getName() == 'admin.manual.rdeposit') active @endif" href="{{route('admin.manual.rdeposit')}}"><i class="icon  fa fa-credit-card"></i>Reject  Manual  Deposit</a></li>
            </ul>
        </li>

        <li class="treeview  @if(request()->route()->getName() == 'admin.blog') is-expanded
          @elseif(request()->route()->getName() == 'admin.blog.add') is-expanded
            @elseif(request()->route()->getName() == 'admin.blog.edit') is-expand
            @endif">
        ...
        <li class="treeview @if(request()->route()->getName() == 'admin.home.page') is-expanded
           ...
           @endif">
            ...
            <ul class="treeview-menu">
                ...
                <li><a class="treeview-item @if(request()->route()->getName() == 'admin.investors') active @endif" href="{{route('admin.investors')}}"><i class="icon fa fa-bars"></i>Top investors</a></li>
        ...
        <li><a class="app-menu__item @if(request()->route()->getName() == 'admin.support.admin.index') active @endif" href="{{route('admin.support.admin.index')}}"><i class="app-menu__icon fa fa-ticket"></i><span class="app-menu__label">Support</span></a></li>
        ...
        <li><a class="app-menu__item" href="{{ route('admin.logout') }}" onclick="event.preventDefault();
            ...
            <form id="logout" action="{{ route('admin.logout') }}" method="get">
                @csrf
            </form>
        </li>
    </ul>
