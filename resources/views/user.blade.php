                ...
                <ul class="navbar-nav m-auto">
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <div class="dropdown-menu " aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item parent" href="{{route('user.transfer.to.ownbank')}}">@lang('Own bank')</a>
                            <a class="dropdown-item parent" href="/user/transfer/balance/other-bank">@lang('Other banks')</a> 
                            <a class="dropdown-item parent" href="{{route('user.withdraw')}}">@lang('E-currency')</a>
                        </div>
                    </li>
