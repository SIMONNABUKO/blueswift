                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <select class='form-control js-example-basic-single' name="bank_continent">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <select class='form-control js-example-basic-single' name="bank_country">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text"  name="bank_name" class="myForn" placeholder="@lang('bank name')" autocomplete="off">
                                        </div>
                                        
                                        
                                        <div class="form-group col-md-12">
                                            <label>@lang('Branch Name')</label>
                                            <input type="text"  name="branch_name" class="myForn" placeholder="@lang('branch name')" autocomplete="off">
                                        </div>
                                        <div class="form-group col-md-12">
