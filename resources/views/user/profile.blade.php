                            ...
                            <form method="post" action="{{route('user.profile.image.upload')}}" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-12">
                                    <div class="fileinput fileinput-new" data-provides="fileinput" >
                                        ...
                                        <!--         <input type="file" name="avatar" disabled> </span>-->
                        ...
                        <form action="{{route('user.profile.update')}}" method="post" class="form-horizontal form-bordered">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" type="text" name="first_name" value="{{Auth::user()->first_name}}" disabled>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="exampleInputEmail1">@lang('Last Name')</label>
                                    <input class="form-control" type="text" name="last_name" value="{{Auth::user()->last_name}}" disabled>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="exampleInputEmail1">@lang('Phone Number')</label>
                                    <input class="form-control" type="text" name="phone" value="{{ Auth::user()->phone }}" disabled>
                                </div>
                                <div class="form-group col-md-6">
                                    <fieldset>
                                        <label class="control-label" >@lang('Email')</label>
                                        <input class="form-control"  value="{{ Auth::user()->email }}" placeholder="Readonly input here…" readonly="" disabled>
                                    </fieldset>
                                </div>
                                <div class="form-group col-md-12">
                                    <fieldset>
                                        <label class="control-label" for="readOnlyInput">@lang('Username')</label>
                                        <input class="form-control"  value="{{ Auth::user()->username }}" placeholder="Readonly input here…" readonly="" disabled>
                                    </fieldset>
                                </div> <div class="form-group col-md-12">
                                    <fieldset>
                                        <label class="control-label" for="readOnlyInput">@lang('Account Number')</label>
                                        <input class="form-control"  value="{{ Auth::user()->account_number}}" placeholder="Readonly input here…" readonly="" disabled>
                                    </fieldset>
                                </div>
